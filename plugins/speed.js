...
{index: 1, urlButton: {displayText: '𝘼𝙨𝙪𝙣𝙖 𝙗𝙤𝙩', url: 'https://github.com/Axel-bytu/Asuna'}},
{index: 2, urlButton: {displayText: '𝙄𝙣𝙨𝙩𝙖𝙜𝙧𝙖𝙢', url: 'https://instagram.com/asunabot'}},
{index: 3, quickReplyButton: {displayText: '𝙊𝙩𝙧𝙖 𝙫𝙚𝙯', id: '#ping'}},
{index: 4, quickReplyButton: {displayText: '𝙑𝙤𝙡𝙫𝙚𝙧 𝙖𝙡 𝙈𝙚𝙣𝙪́', id: '#menu'}},
]
let tm = {
text: veloz,
footer: global.wm,
