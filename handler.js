...
import { plugins, watcher } from './lib/plugins.js'
    ...
    try {
        ...
        try {
            ...
            if (settings) {
                ...
                if (!('nhentai' in canvas)) settings.canvas = false
